    ...
    return FittedBox(
      child: Container(
        ...
        child: Material(
          ...
          color: viewLineColor.withOpacity(0.2),
          child: Stack(
            ...
            children: <Widget>[
              Positioned(
                ...
                child: Icon(Icons.remove, size: 40.0, color: textPrimaryColor),
              ),
              Positioned(
                right: widget.direction == Axis.horizontal ? 10.0 : null,
                top: widget.direction == Axis.horizontal ? null : 10.0,
                child: Icon(Icons.add, size: 40.0, color:textPrimaryColor),
              ),
              GestureDetector(
                    ...
                    child: Center(
                      child: AnimatedSwitcher(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(color: textPrimaryColor, fontSize: 56.0),
                        ),
                      ),
                    ),
                  ),
